...
public interface UserService extends IService<User> {
     ...
     * @return Boolean
     */
    Boolean addUser(UserAddRequest userRequest);
     ...
     * @return
     */
    SystemAdmin getSystemAdminOrMerchantEmployee(Boolean isEmployee);
     ...
     * @return 用户授信统计数据
     */
    com.zbkj.common.response.UserCreditStatisticsResponse getUserCreditStatistics();

    List<Integer> getUserIdsByOrganizationId(String organizationId);
