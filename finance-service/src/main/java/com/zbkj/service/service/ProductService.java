...
public interface ProductService extends IService<Product> {
     ...
     * @return MyRecord
     */
    MyRecord copyProduct(String url, SystemAdmin admin);
     ...
     * @return PageInfo
     */
    PageInfo<ProductActivityResponse> getActivitySearchPage(ProductActivitySearchRequest request, PageParamRequest pageRequest, SystemAdmin admin);
     ...
     * @param idList 商品ID列表
     */
    Boolean batchSubmitAudit(List<Integer> idList, SystemAdmin admin);
   ...
   PageInfo<IntegralProductPageResponse> getIntegralProductPageByPlat(IntegralProductPageSearchRequest request);
     ...
     * 根据三牧优选商品ID查询商品
     *
     * @param sanmuGoodsId 三牧优选商品ID
     * @return Product
     */
    Product getBySanmuGoodsId(String sanmuGoodsId);
     ...
     * @return Boolean
     */
    Boolean updateForSync(ProductAddRequest request);
}
