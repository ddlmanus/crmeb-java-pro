...
import com.zbkj.service.service.CrmebProductSyncService;
...
public class ProductManagerServiceImpl implements ProductManagerService {
    ...
    @Autowired
    private CrmebProductSyncService crmebProductSyncService;
     ...
     */
    @Override
    public ProductSyncResponse syncProducts(ProductSyncRequest request) {
        SystemAdmin admin = SecurityUtil.getLoginUserVo().getUser();
        return productSyncService.syncProducts(request, admin);
    }
    ...
    public PageInfo<ProductActivityResponse> getActivitySearchPage(ProductActivitySearchRequest request, PageParamRequest pageRequest) {
        SystemAdmin admin = SecurityUtil.getLoginUserVo().getUser();
        return productService.getActivitySearchPage(request, pageRequest, admin);
    }
     ...
     */
    @Override
    public Boolean syncProductsFromCrmeb() {
        return crmebProductSyncService.syncProductsFromCrmebApi();
    }
}
