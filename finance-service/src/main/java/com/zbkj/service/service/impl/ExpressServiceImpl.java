...
public class ExpressServiceImpl extends ServiceImpl<ExpressDao, Express> implements ExpressService {
    ...
    public JSONObject template(String com) {
        ...
        param.add("com", com);
        return onePassUtil.postFrom(OnePassConstants.ONE_PASS_API_URL + OnePassConstants.ONE_PASS_API_EXPRESS_TEMP_URI_V2, param, header);
    }
    ...
    private void getExpressList() {
        ...
        JSONObject post = onePassUtil.postFrom(OnePassConstants.ONE_PASS_API_URL + OnePassConstants.ONE_PASS_API_EXPRESS_URI_V2, param, header);
