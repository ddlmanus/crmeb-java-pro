...
public interface OrderService extends IService<Order> {
     ...
     * @return 核销结果
     */
    Boolean verificationOrderByCode(String verifyCode,SystemAdmin systemAdmin);
     ...
     * @return Integer
     */
    Integer getActiveMerchantCountByDate(String date);
     ...
     * @return Integer
     */
    Integer getPaidOrderNumByDate(String date);
