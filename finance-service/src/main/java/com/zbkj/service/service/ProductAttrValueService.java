...
public interface ProductAttrValueService extends IService<ProductAttrValue> {
     ...
     * @return List
     */
    List<ProductAttrValue> getListByProductIdAndType(Integer productId, Integer type, Integer marketingType);
    ...
    List<ProductAttrValue> getByProductIdList(List<Integer> proIdList);
}
