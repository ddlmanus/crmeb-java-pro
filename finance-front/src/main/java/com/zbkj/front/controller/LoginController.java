...
public class LoginController {
     ...
     * @throws Exception
     */
    @ApiOperation(value = "牧码通用户跳转过来的免登录")
    @GetMapping(value = "/third/login")
    public CommonResult<LoginResponse> thirdLogin(@RequestParam("ciphertext")String ciphertext,
                                            @RequestParam("keyword")String keyword
    ) throws Exception {
        return CommonResult.success(loginService.thirdLogin(ciphertext,keyword));
