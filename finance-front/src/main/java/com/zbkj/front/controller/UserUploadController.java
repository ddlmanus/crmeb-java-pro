...
import com.zbkj.common.request.Base64ToMultipartFile;
import com.zbkj.common.request.BaseUploadRequest;
import com.zbkj.common.request.FileReq;
...
public class UserUploadController {
    ...
    public CommonResult<FileResultVo> uploadMilkStationFileForAttachment(@RequestBody FileReq fileReq) throws Exception {
        MultipartFile file = new Base64ToMultipartFile(fileReq.getFileData(), fileReq.getFileName());
        if (!file.isEmpty())
        {
            return CommonResult.success(uploadService.fileUpload(file, fileReq.getModel(), fileReq.getPid(), null));
        }
