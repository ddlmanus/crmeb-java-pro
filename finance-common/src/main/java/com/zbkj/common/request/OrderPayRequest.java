...
public class OrderPayRequest {
    ...
    @StringContains(limitValues = {"weixin","alipay","yue","credit"}, message = "未知的支付方式")
    ...
    @StringContains(limitValues = {"public","mini","h5","yue","wechatIos","wechatAndroid","alipay","alipayApp","video","native","alipayPc","credit"}, message = "未知的支付渠道")
