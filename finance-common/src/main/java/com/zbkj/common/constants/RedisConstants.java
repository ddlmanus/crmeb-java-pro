...
public class RedisConstants {
    ...
    public static final String TOKEN_USER_NORMAL_REDIS = "user:normal:";
    public static final String TOKEN_USER_SHOP_MANAGER_REDIS = "user:shopmanager:";
    ...
    /** 移动端Token过期时间 1个月 */
    public static final long TOKEN_EXPRESS_MINUTES = (60 * 24 * 30);
