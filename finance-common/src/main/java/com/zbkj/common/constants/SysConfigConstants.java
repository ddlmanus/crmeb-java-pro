...
public class SysConfigConstants {
    ...
    /** 授信支付状态 */
    public static final String CONFIG_CREDIT_PAY_STATUS = "credit_pay_status";
    /** 最大授信利率 */
    public static final String CONFIG_MAX_CREDIT_RATE = "max_credit_rate";
    /** 最小授信利率 */
    public static final String CONFIG_MIN_CREDIT_RATE = "min_credit_rate";
