package com.zbkj.pc.interceptor;
...
//        String token = frontTokenComponent.getTokenForMerchantEmployee(request);
...
//        Boolean result = frontTokenComponent.checkForEmployee(token);
        if (!result) {
