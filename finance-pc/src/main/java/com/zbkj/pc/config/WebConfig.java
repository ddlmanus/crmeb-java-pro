package com.zbkj.pc.config;

import com.zbkj.common.interceptor.SwaggerInterceptor;
import com.zbkj.pc.filter.ResponseFilter;
import com.zbkj.pc.interceptor.FrontTokenInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(frontTokenInterceptor()).
                ...
                excludePathPatterns("/api/front/login/third/login").
