...
public class ProductCategoryController {
     ...
     * 同步三牧优选商品分类
     */
   // @PreAuthorize("hasAuthority('platform:product:category:sync')")
    @ApiOperation(value = "同步三牧优选商品分类")
    @RequestMapping(value = "/sync", method = RequestMethod.GET)
    public CommonResult<ProductSyncResponse> sync() {
       return CommonResult.success(productCategoryService.sync());
    }
}
